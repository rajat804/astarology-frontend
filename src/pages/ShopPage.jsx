          ...
          <aside className={`space-y-8 text-sm ${showFilters ? "block" : "hidden lg:block"}`}>
            <div className="bg-white rounded-2xl p-6 shadow-md border border-orange-100">
              ...
              <div className="space-y-6">
                ...
                {(inStock || types.length > 0 || gems.length > 0 || price < 2799) && (
                  <button
                    onClick={() => {
                      setInStock(false);
                      setTypes([]);
                    ...
                    className="w-full mt-4 px-4 py-2 bg-orange-100 text-orange-600 rounded-lg hover:bg-orange-200 transition text-sm font-medium"
                  >
                    Clear All Filters
                  </button>
                )}
