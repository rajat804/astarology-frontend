...
import { FaInfinity, FaMoon, FaStar, FaQuoteLeft, FaChartLine } from "react-icons/fa";
...
const Numerology = () => {
  ...
  const benefits = [
    { icon: GiStarsStack, title: "Life Path Discovery", desc: "Uncover your soul's purpose and life mission", color: "text-purple-500", bgColor: "bg-purple-50" },
    { icon: GiDiamondRing, title: "Name Correction", desc: "Enhance name vibrations for success", color: "text-blue-500", bgColor: "bg-blue-50" },
    { icon: GiCrown, title: "Destiny Analysis", desc: "Predict key life events and opportunities", color: "text-amber-500", bgColor: "bg-amber-50" },
    { icon: GiHeartWings, title: "Relationship Matching", desc: "Find compatibility with partners", color: "text-pink-500", bgColor: "bg-pink-50" },
  ];

  const numberMeanings = [
    { number: 1, title: "The Leader", traits: "Independent, ambitious, pioneering", color: "text-red-500" },
    { number: 2, title: "The Diplomat", traits: "Cooperative, sensitive, intuitive", color: "text-orange-500" },
    { number: 3, title: "The Creator", traits: "Expressive, joyful, artistic", color: "text-yellow-500" },
    { number: 4, title: "The Builder", traits: "Practical, disciplined, organized", color: "text-green-500" },
    { number: 5, title: "The Adventurer", traits: "Freedom-loving, dynamic, versatile", color: "text-cyan-500" },
    { number: 6, title: "The Nurturer", traits: "Responsible, caring, balanced", color: "text-blue-500" },
    { number: 7, title: "The Seeker", traits: "Analytical, spiritual, wise", color: "text-purple-500" },
    { number: 8, title: "The Achiever", traits: "Ambitious, powerful, successful", color: "text-amber-500" },
    { number: 9, title: "The Humanitarian", traits: "Compassionate, generous, idealistic", color: "text-pink-500" },
  ];
    ...
    <>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full mb-6 border border-white/20">
              <GiStarsStack className="text-yellow-400 w-4 h-4" />
              <span className="text-sm font-semibold text-yellow-200">Sacred Numbers</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
              Numerology
            </h1>
            <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
              Discover the hidden power of numbers and unlock your true potential
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center">
                      <GiStarsStack className="text-white w-6 h-6" />
                    </div>
                    <div>
                      <p className="text-xs md:text-sm font-semibold text-gray-900">Your Personal Number</p>
                      <p className="text-xs text-gray-500">Calculate your Life Path Number</p>
                    </div>
                  </div>
                </motion.div>
              </div>
            ...
            >
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-100 to-orange-100 px-3 md:px-4 py-1.5 md:py-2 rounded-full mb-4 md:mb-6">
                ...
                <span className="text-xs md:text-sm font-semibold text-red-600">The Science of Numbers</span>
              </div>
              ...
              <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-4">
                Every number carries a vibration that resonates with your inner self. Numerology reveals how your 
                date of birth and name influence your destiny, character, and opportunities. It's not coincidence — 
                it's cosmic design.
              </p>
              
              <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6">
                At Nakshatraganak, our experts decode your Life Path, Destiny, and Soul Numbers to uncover hidden 
                strengths and challenges. We also suggest name corrections and remedial changes to balance your 
                vibrations for abundance and peace.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link to="/contact" className="px-5 md:px-6 py-2.5 rounded-xl border-2 border-red-200 text-red-600 font-semibold hover:bg-red-50 transition-all duration-300 inline-flex items-center gap-2">
                  Free Number Analysis <HiOutlineArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </motion.div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-100 to-orange-100 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-red-600">Know Your Number</span>
            </div>
            ...
            <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
              Each number carries a unique vibration that shapes your personality and destiny
            </p>
          </motion.div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {numberMeanings.map((item, idx) => (
              <motion.div
                key={item.number}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-gray-600 text-sm">{item.traits}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-12 md:py-20 overflow-hidden bg-gradient-to-b from-offWhite to-orange-50/50">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-green-600 to-red-600 bg-clip-text text-transparent">
              How Numerology Consultation Works
            </h3>
            <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
              Get started with your personalized numerology reading in 3 simple steps
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-6">
            {[
              { step: "01", title: "Share Your Details", desc: "Provide your date of birth and full name for analysis", icon: HiOutlineCalendar },
              { step: "02", title: "Expert Analysis", desc: "Our numerologist calculates and interprets your numbers", icon: GiStarsStack },
              { step: "03", title: "Get Remedies", desc: "Receive personalized guidance and name corrections", icon: GiHeartWings },
            ].map((item, idx) => {
      ...
      <section className="relative py-16 md:py-24 overflow-hidden bg-gradient-to-r from-red-600 to-orange-600">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <GiStarsStack className="w-16 h-16 text-white/80 mx-auto mb-4" />
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
              Ready to Discover Your Numbers?
            </h2>
            <p className="text-lg md:text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Book a personalized numerology consultation today and unlock the secrets hidden in your numbers
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <CTA>Consult Now</CTA>
